"""
Django settings for PoemCastle project.
...
ALLOWED_HOSTS = ['poemcastle-production.up.railway.app/', 'poemcastle.com', '127.0.0.1', '127.0.0.1:8000']
...
WSGI_APPLICATION = 'PoemCastle.wsgi.application'
...
STATICFILES_DIRS = (os.path.join(BASE_DIR, "poem_castle/static"),)
STATICFILES_FINDERS = [
